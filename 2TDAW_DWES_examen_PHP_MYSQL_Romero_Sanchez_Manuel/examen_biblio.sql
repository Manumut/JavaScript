...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-12-2024 a las 10:48:51
...
--
ALTER TABLE `prestamos`
  ADD CONSTRAINT `fk_prest_copia` FOREIGN KEY (`copia`, `libro`) REFERENCES `copias_libros` (`id_copia`, `id_libro`) ON DELETE CASCADE ON UPDATE CASCADE,,
  ADD CONSTRAINT `fk_prest_usu` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`DNI`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
